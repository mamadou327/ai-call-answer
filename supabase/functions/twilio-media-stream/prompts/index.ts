      ...
      return [
        ...commonTools,
        {
          ...
          parameters: {
            ...
            properties: {
              ...
              date: { type: "string", description: "Appointment date in YYYY-MM-DD format. Use the exact date the caller confirmed." },
              time: { type: "string", description: "Appointment start time in 24-hour HH:MM format. This MUST be the exact time the caller confirmed, not the end time, not a suggested nearby slot, and not adjusted for service duration. Example: caller says 2pm -> 14:00." },
            },
        ...
        },
        {
          ...
          parameters: {
            ...
            properties: {
              date: { type: "string" },
              time: { type: "string", description: "Specific requested start time in 24-hour HH:MM format when the caller named one. Example: caller says 2pm -> 14:00." },
              service_name: { type: "string" },
              staff_name: { type: "string" },
        ...
        },
        {
          ...
          parameters: {
            ...
            properties: {
              ...
              new_time: { type: "string", description: "New booking start time in 24-hour HH:MM format. Use the exact time the caller confirmed, not the end time or service duration." },
            },
