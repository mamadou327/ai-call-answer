...
export const generateSalesPitchPdf = async () => {
  const doc = new jsPDF();
  ...
  doc.text("SALES PITCH ONE-PAGER", pageWidth / 2, 13, { align: "center" });
  ...
  doc.text(
    "Your AI receptionist answers calls 24/7, books appointments, and remembers customers",
    pageWidth / 2,
    46,
    { align: "center" }
  );
  ...
  doc.setTextColor(80, 80, 80);
  doc.text(
    "Pays for itself with just 2-3 bookings per month",
    pageWidth / 2,
    pricingY + 22,
    { align: "center" }
  );
