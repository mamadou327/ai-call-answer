...
import { Download, FileText, Sparkles, Phone } from "lucide-react";
import { DemoCallsTab } from "./DemoCallsTab";
...
export const AiviaSalesKitTab = () => {
  const [activeTab, setActiveTab] = useState("sales-kit");
  ...
  return (
    <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
      <TabsList className="border-2 border-foreground bg-background p-1">
        <TabsTrigger 
          value="sales-kit" 
      ...
      <TabsContent value="sales-kit" className="space-y-6 mt-0">
        {/* Header */}
          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-4 text-sm">
              ...
              <div className="p-3 border-2 border-foreground">
                ...
                <p className="text-muted-foreground">Use the Demo Calls tab to play sample conversations</p>
              </div>
              <div className="p-3 border-2 border-foreground">
      ...
      <TabsContent value="demo-calls" className="mt-0">
        <DemoCallsTab />
      </TabsContent>
    </Tabs>
  );
